...
export default function useDashboard() {
  ...
  const isLoading = membersQuery.isLoading || loansQuery.isLoading || transactionsQuery.isLoading
  const error = membersQuery.error || loansQuery.error || transactionsQuery.error
  ...
  }, [membersQuery.data, loansQuery.data, transactionsQuery.data])
